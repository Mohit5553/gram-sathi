...
import { bookElectrician, resetBookingState } from '../../redux/electricianSlice';
...
const BookElectrician = () => {
  ...
  const { bookingSuccess, error, loading } = useSelector((state) => state.electrician);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(bookElectrician({ providerId: id, ...formData }));
  };
